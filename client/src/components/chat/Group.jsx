    ...
    <div className="bg-white h-[95vh]">
      <div className="h-[6vh] w-[76vw] bg-blue-400 flex justify-between  border-b-2 border-gray-700/50">
        ...
        <div className="flex  h-[5vh] w-[20vw] justify-around">
          <button className="pb-2 border-2 mt-1 border-blue-400 hover:border-black hover:bg-blue-300 transition-all hover:shadow-lg hover:rounded-xl transform hover:-translate-y-1 duration-300">
            POST
          </button>
          <button className="pb-2 border-2 mt-1 border-blue-400 hover:border-black hover:bg-blue-300 transition-all hover:shadow-lg hover:rounded-xl transform hover:-translate-y-1 duration-300">
            FILES
