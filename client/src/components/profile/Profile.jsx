...
function Profile() {
  ...
  return (
    <>
    <div className='flex flex-col bg-gradient-to-r from-blue-200 to-blue-100'>
      <NavBar/>
      <div className='flex h-[95vh]'>
      <Sidebar openSidebarToggle={openSidebarToggle} OpenSidebar={OpenSidebar}/>
      
           <div className="flex flex-col items-center w-[30vw] m-2 rounded-3 shadow-2xl">
             {/* Profile section with partitioned background */}
             <div className="relative w-full h-[30vh] bg-gradient-to-r from-blue-300 to-blue-400 rounded-3 shadow-xl">
               {/* Profile Picture */}
           <div
      ...
      <Modal
        ...
        onRequestClose={closeModal}
        contentLabel="Update Profile"
        className=" bg-blue-300 p-5 rounded-5 w-[60vw] "
        overlayClassName="fixed inset-0 flex items-center justify-center ">
